...
const Sort = React.memo(function Sort({ sortItems, activeSortType, onClickSortType }) {
	const [isSortPopupVisible, setVisiblePopup] = useState(false);
